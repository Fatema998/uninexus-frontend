...
/** Static marketing copy, not data — it never varies per student. */
const PRINT_NOTE =
                      ...
                      {shown.map((c) => (
                        ...
                        >
                          ...
                          <p className="mt-1 text-fg-muted">
                            Issued: {date(c.issuedOn)} • {c.serial}
                          </p>
                          <Button variant="outline" size="sm" className="mt-3" asChild>
                            <a href={c.downloadUrl} download>
              ...
              <aside className="flex flex-col gap-6">
                {d.streak && (
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-metric text-warning">{d.streak.days} Days</p>
                ...
                <Card>
                  ...
                  <CardBody>
                    <p className="text-fg-body">{PRINT_NOTE}</p>
