      ...
      {(d) => (
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-card border border-accent-600/20 bg-accent-600/5 p-6">
            ...
            <p className="text-fg-body">{d.cta.body}</p>
            <Button className="mt-4 h-11 text-body">Create study plan</Button>
          </div>
              ...
              {d.exams.map((e) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-link text-brand-700">{e.date}</p>
                    <p className="text-fg-muted">{e.time}</p>
                  </div>
                </div>
              ))}
            </CardBody>
